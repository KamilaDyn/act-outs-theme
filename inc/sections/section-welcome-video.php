            ...
            <div class="<?php echo esc_attr($class); ?>  featured-content-wrapper ">
                ...
                while ($query->have_posts()) : $query->the_post(); ?>
                    <div class="responsive-container ">
                        <div class="img-preloader" style="background-image: url(<?php echo get_theme_file_uri('/assets/images/event3.jpg') ?>); media">
                            ...
                            <span class="watch play-icon"><img src="<?php echo get_theme_file_uri('/assets/images/play-arrow.svg') ?>" alt="play-icon"></span>
                            <h2 class="title-video"> text can be here</h2>
