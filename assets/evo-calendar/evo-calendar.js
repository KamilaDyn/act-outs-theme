    ...
    ((t = (function () {
                ...
                (i.initials = {
                    ...
                    dates: {
                        en: {
                            ...
                            noEventForToday: "No event for this day..  check other days",
                            noEventForThisDay: "No event for this day.. so check other days :)",
                        },
                        es: {
        ...
        (t.prototype.addEventList = function (e) {
            ...
            0 === n.find("[data-event-index]").length && n.empty(),
                ...
                (t += "</p>"),
                e.type && (t += '<p class="event-type">' + e.type + "</p>"),
                e.description && (t += '<p class="event-desc">' + e.description + "</p>"),
                 e.permalink && (t += '<a class="event-permalink" href="'+ e.permalink +'" class="event-permalink"> check details </a>'),
                (t += "</div>"),
                (t += "</div>"),
                n.append(t),
                a.$elements.eventEl
